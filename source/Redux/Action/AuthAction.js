...
import {
    ...
    SET_IS_CHECK,
    RESEND_OTP,
    RESEND_OTP_DONE, GET_PUMP_FORM_INFO, GET_COMPANY_FORM_INFO,
} from '../Constants';
        ...
        .then((res)=>{
            if(res.data.user){
                ...
                if(res.data.user.user_type === "PUMP"){
                    ...
                    fetchAPI('get', 'get-company-form-info', null, res.data.access_token)
                        .then(function (response) {
                            dispatch({
...
export const registerStepTwo = (ImgSrc, address, lat, lng) => {
    return function(dispatch, getState){
