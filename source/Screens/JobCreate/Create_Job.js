...
class Create_Job extends Component {
    ...
    onPostJobPress = () => {
        const {selectedState, selectedJobType, selectedPumpType, line_length, volume, job_name, description, address_1, date_picker, price_from, price_to} = this.state;


        if (selectedState, selectedJobType, selectedPumpType, line_length, volume, job_name, description, address_1, date_picker, price_from, price_to) {
    ...
    onAcceptPress = () => {
        ...
        const {selectedState, selectedJobType, selectedPumpType, line_length, volume, job_name, description, address_1, address_2, date_picker, price_from, price_to} = this.state;
    ...
    render() {
        const {selectedState, selectedJobType, selectedPumpType, line_length, volume, job_name, description, address_1, address_2, date_picker, date_picker_modal, price_from, price_to, terms_modal} = this.state;
                        ...
                        <>
                            <ScrollView showsVerticalScrollIndicator={false} nestedScrollEnabled={true}>
                                <View style={styles.main}>
                                    <Text
                                        style={[styles.Txt, {marginTop: hp('2%'), fontSize: hp('1.8%'), fontFamily: bold}]}> Create
                                        a job for Pumping Company </Text>
                                    ...
                                    <View style={[styles.miniContainer, {
                                        ...
                                        <TouchableOpacity onPress={() => this.setState({date_picker_modal: true})} style={{
                                            flexDirection: 'row',
                                            alignItems: 'center',
                                            ...
                                            }]}>{this.dateFormatter(date_picker)}</Text>
                                    ...
                                    <View style={[styles.row, {
                                        ...
                                        <View style={[styles.row, {flex: 2, justifyContent: 'flex-end'}]}>
                                            <View style={[styles.row, {
                                                ...
                                                <Text
                                                    style={[styles.label, {fontFamily: regular, fontSize: hp('1.75%')}]}>From</Text>
