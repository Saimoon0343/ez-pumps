                ...
                <Tab.Screen initialParams={{type}} name="Jobs" component={JobsStack}
                            ...
                            options={{
                                tabBarIcon: ({focused,color}) => (
                                    // focused ?
                                        <Icon name="send" size={hp('2.7%')} color={color}
                                              style={{marginBottom: '-20%'}}/>
                                        // :
                                        // <Icon name="send" size={hp('2.7%')} color={white}
                                        //       style={{marginBottom: '-20%'}}/>
            ...
            <Tab.Screen name="My Jobs" component={MyJobsStack}
                        options={{
                            tabBarIcon: ({focused}) => (
                                ...
                                focused ?
                                    <MatIcon name="work" size={hp('3.2%')} color={secondary}
                                             style={{marginBottom: '-20%'}}/>
                                    :
                                    <MatIcon name="work" size={hp('3.2%')} color={white}
                                             style={{marginBottom: '-20%'}}/>
                            ),
                        }}
            />
                ...
                <Tab.Screen name="Pumps" component={PumpsStack}
                            options={{
                                tabBarIcon: ({focused}) => (
                                    ...
                                    focused ?
                                        <PumpIconRed width={hp('5%')} height={hp('5%')}
            ...
            <>
                <Tab.Screen initialParams={{type}} name="Job Requests" component={JobRequestsStack}
                            options={{
                                tabBarIcon: ({focused}) => (
                                    focused ?
                                        <MatCommIcon name="clipboard-plus" size={hp('3.2%')} color={secondary}
                                                     style={{marginBottom: '-20%'}}/>
                                        :
                                        <MatCommIcon name="clipboard-plus" size={hp('3.2%')} color={white}
                                                     style={{marginBottom: '-20%'}}/>
                ...
                <Tab.Screen name="Create Job" component={CreateJobStack}
                            options={{
                                tabBarIcon: ({focused}) => (
                                    ...
                                    focused ?
                                        <IonIcon name="create" size={hp('3.3%')} color={secondary}
                                                 style={{marginBottom: '-20%'}}/>
                                        :
                                        <IonIcon name="create" size={hp('3.3%')} color={white}
                                                 style={{marginBottom: '-20%'}}/>
                                ),
                            }}
                />
            ...
            <Tab.Screen name="Account" component={AccountStack}
                        options={{
                            ...
                            tabBarIcon: ({focused}) => (
                                ...
                                focused ?
                                    <IonIcon name="person" size={hp('3.3%')} color={secondary}
                                             style={{marginBottom: '-20%'}}/>
                                    :
                                    <IonIcon name="person" size={hp('3.3%')} color={white}
                                             style={{marginBottom: '-20%'}}/>
                            ),
                        }}
            />
...
function JobRequestsStack(params) {
    return (
        <Stack.Navigator screenOptions={{headerShown: false}} initialRouteName="JobType">
